...
SAMPLES = {os.path.basename(fn).split("-")[0]: fn
           for fn in glob("/mnt/archgen/users/schumacher/bachelorthesis/04-analysis/snakemake_assembly/alignment/megahit/*-megahit.fasta.gz")}
################################################################################
...
rule bakta:
    ...
    input:
        ...
        db = "03-data/refdbs/bakta/downloaded"
    output:
    ...
    params:
        ...
        dbdir = "/mnt/archgen/users/schumacher/bachelorthesis/03-data/refdbs/bakta/db",
